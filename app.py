  ...
  <div style="display:flex;gap:1.6rem;align-items:flex-start;">
    <div style="flex:1;">
      ...
      <div class="hero-commit">
        ✦ 入组承诺：若获认可，不再参加其他任何院校夏令营考核，从暑假起全程留京，随时投入课题组科研工作；若科研表现优秀，期望申请硕博连读，长期深耕本方向。
      </div>
    </div>
    {photo_html}
  </div>
...
若能有幸得到您的认可与接纳，我将<b>不再参加其他任何院校的夏令营考核</b>；愿意从这个暑假开始，直至大四整个学年，<b>全程留在北京</b>跟进课题组科研任务，随时听从老师和组里安排，提前进组适应节奏、投入科研工作。若科研表现优秀，我亦<b>期望申请硕博连读</b>，继续在本方向深耕，争取做出更系统的研究成果。
</div>
