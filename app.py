...
HIGHLIGHT_AWARDS = [
    (
        ...
        "2024 · 2025",
        "国家级",
        "由教育部直接颁发，是本科阶段可获得的<b>国家最高级别奖学金</b>，全国高校评定比例约 0.2%，须在综合素质与学业成绩上持续位列全校顶尖行列方可入选。连续两年获评，表明学业水平在整个本科阶段保持高水准，而非偶发性发挥。",
    ...
    (
        ...
        "2024 年 11 月",
        "全国",
        "全国性学科竞赛，面向全国高校本科生，赛题综合考核<b>统计分析、数据可视化与科学传播</b>能力，竞争充分。一等奖代表全国顶尖水平，体现跨学科数据处理与展示能力，与人工智能及地球物理反演方向的综合实践能力直接挂钩。",
    ...
    (
        ...
        "2025 年 11 月",
        "院级最高荣誉",
        "学院年度评选的个人最高荣誉之一，专门表彰在<b>创新创业领域取得突出成绩</b>的本科生，入选须在创新项目、竞赛获奖或成果落地方面有具体贡献。该荣誉是对省级大创项目、竞赛获奖、软著申请等一系列成果的综合认定，也是课题组跨学科合作潜力的有力背书。",
...
AWARDS = [
    ...
    ("2025 年青马工程第 81 期优秀学员",                  "综合荣誉", "校级",     "2025年中国海洋大学青马工程第81期优秀学员.jpg"),
    ("2025-2026 学年学生会标兵分会优秀分会",             "综合荣誉", "校级",     "2025-2026学年学生会标兵分会优秀分会.jpg"),
    ("第二十一届杰出青年志愿者",                        "志愿服务", "校级",     "第二十一届杰出青年志愿者名单.jpg"),
    ("青年志愿服务先进集体",                            "志愿服务", "校级",     "青年志愿服务先进集体名单.jpg"),
